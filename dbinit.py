...
CREATE TABLE WATCHLIST IF NOT EXISTS WATCHLIST(
  id BIGSERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE MOVIEPOSTS IF NOT EXISTS MOVIEPOSTS(
  id BIGSERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE MOVIES IF NOT EXISTS MOVIES (
  id BIGSERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE STARS IF NOT EXISTS STARS(
  id BIGSERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE FORUMPOSTS IF NOT EXISTS FORUMPOSTS (
  id BIGSERIAL PRIMARY KEY NOT NULL,
  username VARCHAR(25) NOT NULL,
...
CREATE TABLE COMMENTS IF NOT EXISTS COMMENTS(
  id BIGSERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE DISCUSSION IF NOT EXISTS DISCUSSION(
  id BIGSERIAL PRIMARY KEY NOT NULL,
  username VARCHAR(25) NOT NULL,
...
CREATE TABLE IN_THEATERS IF NOT EXISTS IN_THEATERS(
  id BIGSERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE SHOWTIMES IF NOT EXISTS SHOWTIMES(
  id BIGSERIAL PRIMARY KEY NOT NULL,
  title VARCHAR NOT NULL,
...
CREATE TABLE TICKETS IF NOT EXISTS TICKETS(
  id BIGSERIAL PRIMARY KEY NOT NULL,
